...
-- CLIENTES (Tabla de servicio-contenedores)
...
-- DEPOSITOS (Tabla de servicio-deposito - ddl-auto=update la creará)
-- Asumimos una tabla 'ciudades' simple por ahora
...
-- CAMIONES (Tabla de servicio-transporte)
...
-- TARIFAS (Tabla de servicio-tarifa)
